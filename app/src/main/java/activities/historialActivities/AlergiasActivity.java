...
/**
 * Actividad que se encarga de presentar la lista de alergias del elemento de historia clínica de un paciente
 */
public class AlergiasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Alergias del paciente");
        setSupportActionBar(toolbar);

        Bundle extras = getIntent().getExtras();
        if(extras != null)
            alergias = (ArrayList<Alergias>) extras.get("alergias");

        ViewGroup rootView = (ViewGroup) findViewById(R.id.contenedor_padre);

        for(Alergias a: alergias){
            ...
            imageView.setImageResource(R.drawable.alergia);
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("Alergias Page") // TODO: Define a title for the content shown.
