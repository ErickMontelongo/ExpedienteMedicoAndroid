...
/**
 * Actividad que se encarga de presentar las vacunas que se ha aplicado un paciente
 */
public class VacunasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Vacunas del paciente");
        setSupportActionBar(toolbar);

        Bundle extras = getIntent().getExtras();
        if(extras != null)
            vacunas = (ArrayList<Vacunas>) extras.get("vacunas");

        ViewGroup rootView = (ViewGroup) findViewById(R.id.contenedor_padre);

        for(Vacunas a: vacunas){
            ...
            imageView.setImageResource(R.drawable.vacuna);
            _nombre.setText(a.getNombre());
            _vivo.setText("Fecha de aplicación: "+a.getFecha().toString());
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("Vacunas Page") // TODO: Define a title for the content shown.
